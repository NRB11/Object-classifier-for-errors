...
def start_training():
    ...
    classify_button_critical = tk.Button(training_window, text="Critical Error", bg="red", fg="white")
    classify_button_critical.pack(side="left", padx=10, pady=10)

    classify_button_non_critical = tk.Button(training_window, text="Non Critical Error", bg="orange", fg="white")
    classify_button_non_critical.pack(side="left", padx=10, pady=10)

    classify_button_no_error = tk.Button(training_window, text="No Error", bg="gray", fg="white")
    classify_button_no_error.pack(side="left", padx=10, pady=10)
